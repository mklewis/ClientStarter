...
angular.module('clientApp')
  ...
  function ( $rootScope, screenSize ) {
    ...
    tableCtrl.isSortable = function(heading){
    ...
    tableCtrl.detailsToShow = function(){
        var show = false;
        _.each(tableCtrl.headings, function(heading){
            if (!tableCtrl.shouldShow(heading.name, false)){
                show = true;
            }
        });
        return show;
    ...
    tableCtrl.shouldShow = function(colName, isDetailRow){
        ...
        if(!col.collapseAt){
            ...
            switch(col.collapseAt){
                case 'lg':
                    if(!isDetailRow){
                        if(tableCtrl.media_lg)
                            return false;
                        if(tableCtrl.media_md)
                            return false;
                        if(tableCtrl.media_sm)
                            return false;
                        if(tableCtrl.media_xs)
                            return false;
                    }else{
                        if(tableCtrl.media_lg)
                            return true;
